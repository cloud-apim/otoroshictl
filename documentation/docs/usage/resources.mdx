...
<Terminal  
    command="otoroshictl resources -h"
    result={`
...
<Terminal 
    command="otoroshictl resources get certificates"
    result={`
...
<Terminal 
    command="otoroshictl resources get -h"
    result={`
...
<Terminal 
    command="otoroshictl resources get certificates otoroshi-client"
    result={`
...
<Terminal 
    command="otoroshictl resources delete certificates otoroshi-client" />

details of the command

<Terminal 
    command="otoroshictl resources delete -h"
    result={`
...
<Terminal command="otoroshictl resources create route -f ./route.json" />
<Terminal command="otoroshictl resources create route -f https://www.foo.bar/route.json" />

or using stdin

<Terminal command="cat ./route.json | otoroshi resources create route --stdin" />

or using the `--data` flag

<Terminal command={`otoroshictl resources create route \\
...
<Terminal command="otoroshictl resources create route '{kind':'Route', ... }'" />
...
<Terminal command="otoroshictl resources create -h" result={`
...
<Terminal command="otoroshictl resources edit route my-route -f ./my-route.json" />
<Terminal command="otoroshictl resources edit route my-route -f https://www.foo.bar/my-route.json" />

or using stdin

<Terminal command="cat ./my-route.json | otoroshi resources edit route my-route --stdin" />

or using the `--data` flag

<Terminal command={`otoroshictl resources edit route my-route \\
  --data name=my-route \\
...
<Terminal command="otoroshictl resources edit route my-route '{'kind':'Route', ... }'" />
...
<Terminal command="otoroshictl resources edit -h"
    result={`
...
<Terminal 
    command="otoroshictl resources patch -h"
    result={`
...
<Terminal command="otoroshictl resources import -f ./export.json" />
<Terminal command="otoroshictl resources import -f https://www.foo.bar/export.json" />
...
<Terminal command="otoroshictl resources import -h"
    result={`
...
<Terminal command="otoroshictl resources export -f export.json" />

you can also specify a directory, in that case entities will be exported with one file per kind

<Terminal 
    command="otoroshictl resources export -d export"
    result={`
...
<Terminal 
    command="otoroshictl resources export -d export --split-files"
    result={`
...
<Terminal command="otoroshictl resources export -d export --split-files -o yaml --kube" />

the details of the command

<Terminal 
    command="otoroshictl resources export -h"
    result={`
...
<Terminal command="otoroshictl resources apply -f entities.json" />
<Terminal command="otoroshictl resources apply -f https://www.foo.bar/entities.json" />

or even a directory

<Terminal command="otoroshictl resources apply -d entities --recursive" />

you can also add a `--watch` flag to keep everything in sync as you edit files

<Terminal command="otoroshictl resources apply -d entities --recursive --watch" />

the details of the command

<Terminal 
    command="otoroshictl resources apply -h"
    result={`
...
<Terminal  
    command="otoroshictl resources template apikey"
    result={`
...
<Terminal not_ended 
    command="otoroshictl resources crds"
    result={`
...
<Terminal not_ended 
    command="otoroshictl resources rbac"
    result={`
