...
<Terminal command="otoroshictl cloud-apim login" />
...
<Terminal  
    command="otoroshictl cloud-apim list"
    result={`
...
<Terminal command="otoroshictl cloud-apim link wasi-wasm-demo" />


## Cloud APIM subcommands

<Terminal 
    command="otoroshictl cloud-apim -ht"
    result={`
