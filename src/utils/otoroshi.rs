...
impl Otoroshi {
    ...
    pub async fn get_one_resource_with_config(
        ...
        match Self::get_otoroshi_resource(
            format!("/apis/any/v1/{}/{}", entity, id).as_str(),
            None,
            config,
        )
        .await
    ...
    pub async fn create_one_resource_with_content_type(
        ...
        match Self::otoroshi_call(
            Method::POST,
            format!("/apis/any/v1/{}", entity).as_str(),
            None,
            Some(hyper::Body::from(body)),
            Some(content_type),
            config,
    ...
    pub async fn get_resource_template(entity: String, opts: CliOpts) -> Option<serde_json::Value> {
        ...
        match Self::otoroshi_call(
            Method::GET,
            format!("/apis/any/v1/{}/_template", entity).as_str(),
            None,
            None,
            Some("application/json".to_string()),
            config,
    ...
    pub async fn get_resources(
        ...
        match Self::get_otoroshi_resource(
            format!(
                "/apis/any/v1/{}?page={}&pageSize={}{}",
                entity, page, page_size, filtering
            )
            .as_str(),
            None,
            config,
